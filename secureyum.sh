...
su -l -c "yum install rkhunter && rkhunter --update"

su -l -c "rkhunter --check && yum remove rkhunter"
...
su -l -c "yum install iptables && iptables -A INPUT -p tcp -s 127.0.0.1 --d-port 22 -j ACCEPT"
...
su -l -c "yum install aide && aideinit"
