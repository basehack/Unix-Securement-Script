...
su -l -c "zypper rkhunter && rkhunter --update"

su -l -c "rkhunter --check && zypper remove rkhunter"
...
su -l -c "zypper install iptables && iptables -A INPUT -p tcp -s 127.0.0.1 --d-port 22 -j ACCEPT"
...
su -l -c "zypper install aide && aideinit"
