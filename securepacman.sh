...
su -l -c "pacman -S rkhunter && rkhunter --update"

su -l -c "rkhunter --check && pacman -R rkhunter"
...
su -l -c "pacman -S iptables && iptables -A INPUT -p tcp -s 127.0.0.1 --d-port 22 -j ACCEPT"
